...
class Result(EnumBase):
    ...
    ERROR_CAMERA_UNAVAILABLE_BD = -1000755000
    ERROR_CAMERA_OCCUPIED_BD = -1000755001
    ERROR_CAMERA_CAPTURE_SESSION_CAPTURING_BD = -1000755002
    ERROR_CAMERA_CAPTURE_SESSION_NOT_CAPTURING_BD = -1000755003
    ERROR_CAMERA_ID_INVALID_BD = -1000755004
    ERROR_CAMERA_IMAGE_ID_INVALID_BD = -1000755005
    ERROR_CAMERA_PROPERTY_TYPE_INVALID_BD = -1000755006
    ERROR_CAMERA_CAPABILITY_TYPE_INVALID_BD = -1000755007
    ERROR_IMAGE_BUFFER_EXHAUSTED_BD = -1000755008
    ERROR_SPATIAL_PERSISTENCE_SCOPE_UNSUPPORTED_EXT = -1000763001
    ERROR_SPATIAL_PERSISTENCE_SCOPE_INCOMPATIBLE_EXT = -1000781001
    ERROR_SPATIAL_IMAGE_FORMAT_UNSUPPORTED_EXT = -1000782001
    ERROR_SPATIAL_IMAGE_INVALID_EXT = -1000782002
    ERROR_SPATIAL_IMAGE_SIZE_MISSING_EXT = -1000782003
    ...
    ERROR_SPATIAL_CONTAINER_CLOSED_EXT = -1000810000
    ERROR_SPATIAL_CONTAINERS_ENABLED_EXT = -1000810001
    ERROR_SPATIAL_CONTAINERS_NOT_ENABLED_EXT = -1000810002
    ERROR_COMPATIBLE_SPATIAL_CONTAINER_MISSING_EXT = -1000810003
    ERROR_SPATIAL_CONTAINER_IS_RENDERING_EXT = -1000813001
    ERROR_SPATIAL_CONTAINER_NOT_RENDERING_EXT = -1000813002
    ERROR_SPATIAL_CONTAINER_MISSING_EXT = -1000813003
    ERROR_SPATIAL_CONTAINER_DUPLICATE_EXT = -1000813004
    ERROR_SPATIAL_CONTAINER_GRAPHICS_PRESENTATION_MISSING_EXT = -1000813005
...
class StructureType(EnumBase):
    ...
    SPATIAL_ENTITY_COMPONENT_DATA_SPHERE_BD = 1000389022
    ...
    BODY_TRACKING_POSTURE_DATA_BD = 1000395001
    BODY_JOINT_VELOCITIES_BD = 1000395002
    BODY_JOINT_ACCELERATIONS_BD = 1000395003
    BODY_TRACKING_STATE_BD = 1000395004
    ...
    SYSTEM_LIGHT_ESTIMATION_PROPERTIES_BD = 1000397000
    SENSE_DATA_PROVIDER_CREATE_INFO_LIGHT_ESTIMATION_BD = 1000397001
    ENVIRONMENT_TEXTURE_CREATE_CONFIG_INFO_BD = 1000397002
    LIGHT_ESTIMATION_DATA_ENVIRONMENT_TEXTURE_RAW_BD = 1000397003
    LIGHT_ESTIMATION_DATA_SPHERICAL_HARMONICS_BD = 1000397005
    SPATIAL_ENTITY_COMPONENT_DATA_LIGHT_ESTIMATION_BD = 1000397006
    ...
    HAND_TRACKING_UNEXTRAPOLATED_POSES_REQUEST_META = 1000693000
    HAND_TRACKING_UNEXTRAPOLATED_POSES_META = 1000693001
    ...
    SYSTEM_DYNAMIC_OBJECT_TRACKING_PROPERTIES_BD = 1000746000
    SENSE_DATA_PROVIDER_CREATE_INFO_DYNAMIC_OBJECT_BD = 1000746001
    SPATIAL_ENTITY_COMPONENT_DATA_DYNAMIC_OBJECT_BD = 1000746002
    DYNAMIC_OBJECT_DATA_BD = 1000746003
    SENSE_DATA_FILTER_DYNAMIC_OBJECT_TYPE_BD = 1000746004
    SYSTEM_DYNAMIC_OBJECT_KEYBOARD_PROPERTIES_BD = 1000747000
    SYSTEM_DYNAMIC_OBJECT_MOUSE_PROPERTIES_BD = 1000748000
    AVAILABLE_CAMERAS_ENUMERATE_INFO_BD = 1000755000
    CAMERA_PROPERTIES_GET_INFO_BD = 1000755001
    CAMERA_PROPERTIES_BD = 1000755002
    CAMERA_PROPERTY_FACING_BD = 1000755003
    CAMERA_PROPERTY_POSITION_BD = 1000755004
    CAMERA_PROPERTY_CAMERA_TYPE_BD = 1000755005
    CAMERA_SUPPORTED_CAPABILITIES_GET_INFO_BD = 1000755006
    CAMERA_SUPPORTED_CAPABILITIES_BD = 1000755007
    CAMERA_SUPPORTED_CAPABILITY_IMAGE_RESOLUTION_AND_FRAME_RATE_BD = 1000755008
    CAMERA_CAPABILITY_IMAGE_RESOLUTION_AND_FRAME_RATE_BD = 1000755009
    CAMERA_SUPPORTED_CAPABILITY_DATA_TRANSFER_TYPE_BD = 1000755010
    CAMERA_CAPABILITY_DATA_TRANSFER_TYPE_BD = 1000755011
    CAMERA_SUPPORTED_CAPABILITY_IMAGE_FORMAT_BD = 1000755012
    CAMERA_CAPABILITY_IMAGE_FORMAT_BD = 1000755013
    CAMERA_SUPPORTED_CAPABILITY_CAMERA_MODEL_BD = 1000755014
    CAMERA_CAPABILITY_CAMERA_MODEL_BD = 1000755015
    CAMERA_DEVICE_CREATE_INFO_BD = 1000755016
    CREATE_CAMERA_DEVICE_COMPLETION_BD = 1000755017
    CAMERA_CAPTURE_SESSION_CREATE_INFO_BD = 1000755018
    CREATE_CAMERA_CAPTURE_SESSION_COMPLETION_BD = 1000755019
    CAMERA_INTRINSICS_BD = 1000755020
    CAMERA_EXTRINSICS_BD = 1000755021
    CAMERA_CAPTURE_BEGIN_INFO_BD = 1000755022
    CAMERA_IMAGE_ACQUIRE_INFO_BD = 1000755023
    CAMERA_IMAGE_BD = 1000755024
    CAMERA_IMAGE_DATA_RAW_BUFFER_BD = 1000755025
    CAMERA_CAPABILITIES_BD = 1000755026
    CAMERA_CAPABILITY_TYPES_ENUMERATE_INFO_BD = 1000755027
    CAMERA_CAPABILITY_TYPES_BD = 1000755028
    CAMERA_PROPERTY_TYPES_ENUMERATE_INFO_BD = 1000755029
    CAMERA_PROPERTY_TYPES_BD = 1000755030
    AVAILABLE_CAMERA_BD = 1000755031
    SPATIAL_BOUNDS_SPHEREF_ANDROID = 1000761000
    SPATIAL_BOUNDS_BOXF_ANDROID = 1000761001
    SPATIAL_BOUNDS_FRUSTUMF_ANDROID = 1000761002
    ...
    COLOR_SPACES_ENUMERATE_INFO_SONY = 1000776000
    SWAPCHAIN_CREATE_INFO_COLOR_SPACE_SONY = 1000776001
    HDR_METADATA_SONY = 1000777000
    ...
    SPATIAL_REFERENCE_IMAGE_EXT = 1000782000
    SPATIAL_IMAGE_STATIC_OPTIMIZATION_EXT = 1000782001
    SPATIAL_IMAGE_SIZE_EXT = 1000782002
    SPATIAL_CAPABILITY_CONFIGURATION_IMAGE_TRACKING_EXT = 1000782003
    SPATIAL_IMAGE_TRACKING_DATABASE_CREATE_INFO_EXT = 1000782004
    SPATIAL_COMPONENT_IMAGE_2D_LIST_EXT = 1000782005
    CREATE_SPATIAL_IMAGE_TRACKING_DATABASE_COMPLETION_EXT = 1000782006
    ...
    GOOGLE_CLOUD_AUTH_INFO_API_KEY_ANDROID = 1000787000
    GOOGLE_CLOUD_AUTH_INFO_TOKEN_ANDROID = 1000787001
    GOOGLE_CLOUD_AUTH_INFO_KEYLESS_ANDROID = 1000787002
    GOOGLE_CLOUD_AUTH_ERROR_RESULT_ANDROID = 1000787003
    SYSTEM_GEOSPATIAL_PROPERTIES_ANDROID = 1000789000
    GEOSPATIAL_TRACKER_CREATE_INFO_ANDROID = 1000789001
    EVENT_DATA_GEOSPATIAL_TRACKER_STATE_CHANGED_ANDROID = 1000789002
    GEOSPATIAL_POSE_FROM_POSE_LOCATE_INFO_ANDROID = 1000789003
    GEOSPATIAL_POSE_RESULT_ANDROID = 1000789004
    GEOSPATIAL_POSE_LOCATE_INFO_ANDROID = 1000789005
    VPS_AVAILABILITY_CHECK_COMPLETION_ANDROID = 1000789006
    ...
    GEOSPATIAL_ANCHOR_CREATE_INFO_ANDROID = 1000797000
    SURFACE_ANCHOR_CREATE_INFO_ANDROID = 1000797001
    SURFACE_ANCHOR_CREATE_COMPLETION_ANDROID = 1000797002
    SYSTEM_GEOSPATIAL_ANCHOR_PROPERTIES_ANDROID = 1000797003
    GEOSPATIAL_TRACKER_ANCHOR_TRACKING_INFO_ANDROID = 1000797004
    SPATIAL_CONTAINER_CREATE_INFO_EXT = 1000810000
    SPATIAL_CONTAINER_SPACE_CREATE_INFO_EXT = 1000810001
    EVENT_DATA_SPATIAL_CONTAINER_CLOSED_EXT = 1000810003
    SYSTEM_SPATIAL_CONTAINER_PROPERTIES_EXT = 1000810004
    SPATIAL_CONTAINER_BOUNDS_EXT = 1000810005
    EVENT_DATA_SPATIAL_CONTAINER_BOUNDS_CHANGED_EXT = 1000810006
    SPATIAL_CONTAINER_BOUNDS_GET_INFO_EXT = 1000810007
    SPATIAL_CONTAINER_STATE_GET_INFO_EXT = 1000810008
    SPATIAL_CONTAINER_VISIBLE_REQUEST_INFO_EXT = 1000810009
    EVENT_DATA_SPATIAL_CONTAINER_VISIBLE_CHANGED_EXT = 1000810010
    EVENT_DATA_SPATIAL_CONTAINER_VISIBLE_REQUEST_DENIED_EXT = 1000810011
    EVENT_DATA_SPATIAL_CONTAINER_INTERACTABLE_CHANGED_EXT = 1000810012
    SPATIAL_CONTAINER_BOUNDS_MODE_REQUEST_INFO_EXT = 1000810013
    EVENT_DATA_SPATIAL_CONTAINER_BOUNDS_MODE_REQUEST_DENIED_EXT = 1000810014
    SPATIAL_CONTAINER_STATE_EXT = 1000810015
    SESSION_CREATE_INFO_SPATIAL_CONTAINERS_EXT = 1000810016
    SPATIAL_CONTAINER_VIEW_LOCATE_INFO_EXT = 1000813000
    SPATIAL_CONTAINER_VIEWS_LOCATE_INFO_EXT = 1000813001
    SPATIAL_CONTAINER_VIEW_STATE_EXT = 1000813002
    SPATIAL_CONTAINER_LAYER_EXT = 1000813003
    SPATIAL_CONTAINER_LAYER_FRAME_END_INFO_EXT = 1000813004
    SPATIAL_CONTAINER_BEGIN_INFO_EXT = 1000813005
    SPATIAL_CONTAINER_COMPOSITION_LAYER_VIEW_CONFIGURATION_EXT = 1000813006
    SPATIAL_CONTAINER_END_INFO_EXT = 1000813007
    SPATIAL_CONTAINER_LAYER_VOLUME_CLIPPING_EXT = 1000813008
...
class ObjectType(EnumBase):
    ...
    CAMERA_DEVICE_BD = 1000755000
    CAMERA_CAPTURE_SESSION_BD = 1000755001
    SPATIAL_PERSISTENCE_CONTEXT_EXT = 1000763000
    SPATIAL_IMAGE_TRACKING_DATABASE_EXT = 1000782000
    GEOSPATIAL_TRACKER_ANDROID = 1000789000
    SPATIAL_CONTAINER_EXT = 1000810000
...
class BodyTrackingFidelityMETA(EnumBase):
    LOW = 1
    HIGH = 2
...
class TrackingOptimizationSettingsHintQCOM(EnumBase):
    NONE = 0
    LONG_RANGE_PRIORITIZATION = 1
    CLOSE_RANGE_PRIORITIZATION = 2
    LOW_POWER_PRIORITIZATION = 3
    HIGH_POWER_PRIORITIZATION = 4
...
class HandGestureTypeQCOM(EnumBase):
    UNKNOWN = -1
    OPEN_HAND = 0
    GRAB = 2
    PINCH = 7
...
class SpatialEntityComponentTypeBD(EnumBase):
    ...
    LIGHT_ESTIMATION = 1000397000
    DYNAMIC_OBJECT = 1000746000
...
class BodyTrackingPostureBD(EnumBase):
    STOMP = 1
    STATIC = 2


class BodyTrackingStatusBD(EnumBase):
    INVALID = 0
    VALID = 1
    LIMITED = 2


class BodyTrackingMessageBD(EnumBase):
    NO_ERROR = 0
    TRACKER_NOT_CALIBRATED = 1
    TRACKER_NUM_NOT_ENOUGH = 2
    TRACKER_STATE_NOT_SATISFIED = 3
    TRACKER_PERSISTENT_INVISIBILITY = 4
    TRACKER_DATA_ERROR = 5
    USER_CHANGE = 6
    TRACKING_POSE_ERROR = 7
...
class EnvironmentTexturePixelFormatBD(EnumBase):
    RGB_16FLOAT = 0
    RGBA_16FLOAT = 1


class EnvironmentTextureResolutionBD(EnumBase):
    N8_8 = 0
    N16_16 = 1
    N32_32 = 2
    N64_64 = 3
...
class EnvironmentTextureTransferTypeBD(EnumBase):
    RAW = 0


class SphericalHarmonicsKindBD(EnumBase):
    TOTAL = 0


class AudioSampleRateBD(EnumBase):
    N192000_HZ = 1
    N96000_HZ = 2
    N48000_HZ = 3
    N44100_HZ = 4
...
class AudioBufferChannelLayoutBD(EnumBase):
    INTERLEAVED = 0
    PLANAR = 1


class SoundObjectDistanceAttenuationTypeBD(EnumBase):
    NONE = 0
    INVERSE_SQUARE = 1
    ROLLOFF = 2
    CUSTOMIZED = 100
...
class SoundFieldChannelMaskSurroundBD(EnumBase):
    FRONT_LEFT = 1
    FRONT_RIGHT = 2
    FRONT_CENTER = 4
    LOW_FREQUENCY = 8
    ...
    BACK_CENTER = 4096
    TOP_SIDE_LEFT = 8192
    TOP_SIDE_RIGHT = 16384
    SETUP_STEREO = 3
    SETUP_2_1 = 11
    SETUP_3_0 = 7
    SETUP_4_0 = 4099
    SETUP_BACK_SURROUND = 48
    SETUP_QUAD = 51
    SETUP_3_1 = 15
    SETUP_5_0 = 55
    SETUP_SIDE_SURROUND = 192
    SETUP_5_0_SIDE = 199
    SETUP_5_1 = 63
    SETUP_5_1_SIDE = 207
    SETUP_7_0 = 247
...
class SoundFieldChannelMaskAmbixBD(EnumBase):
    N1ST_ORDER = 1
    N2ND_ORDER = 2
    N3RD_ORDER = 3
    N4TH_ORDER = 4
...
class SoundFieldChannelMaskFumaBD(EnumBase):
    N1ST_ORDER = 1


class SoundObstacleMaterialTypeBD(EnumBase):
    ACOUSTIC_TILE = 0
    BRICK = 1
    BRICK_PAINTED = 2
    CARPET = 3
    CARPET_HEAVY = 4
    CARPET_HEAVY_PADDED = 5
    CERAMIC_TILE = 6
    CONCRETE = 7
    CONCRETE_ROUGH = 8
    CONCRETE_BLOCK = 9
    CONCRETE_BLOCK_PAINTED = 10
    CURTAIN = 11
    FOLIAGE = 12
    GLASS = 13
    GLASS_HEAVY = 14
...
class HandTrackingDataSourceEXT(EnumBase):
    UNOBSTRUCTED = 1
    CONTROLLER = 2
    UNOBSTRUCTED_WIDE_MOTION_ = 1000695000
...
class EyeIndexANDROID(EnumBase):
    LEFT = 0
    RIGHT = 1


class EyeStateANDROID(EnumBase):
    INVALID = 0
    GAZING = 1
    SHUT = 2


class EyeTrackingModeANDROID(EnumBase):
    NOT_TRACKING = 0
    RIGHT = 1
    LEFT = 2
    BOTH = 3
...
class WindingOrderANDROID(EnumBase):
    UNKNOWN = 0
    CW = 1
    CCW = 2


class PerformanceMetricsCounterUnitANDROID(EnumBase):
    GENERIC = 0
    PERCENTAGE = 1
    MILLISECONDS = 2
    BYTES = 3
...
class BoundaryVisibilityMETA(EnumBase):
    NOT_SUPPRESSED = 1
    SUPPRESSED = 2


class FaceTrackingVisemeMETA(EnumBase):
    SIL = 0
    PP = 1
    FF = 2
    TH = 3
...
class SemanticLabelMETA(EnumBase):
    UNKNOWN = 0
    FLOOR = 1
    CEILING = 2
    WALL_FACE = 3
    INNER_WALL_FACE = 4
    INVISIBLE_WALL_FACE = 5
    DOOR_FRAME = 6
    WINDOW_FRAME = 7


class EnvironmentRaycastHitStatusMETA(EnumBase):
    HIT = 1
    NO_HIT = 2
    HIT_POINT_OCCLUDED = 3
    HIT_POINT_OUTSIDE_OF_FOV = 4
    RAY_OCCLUDED = 5
    HIT_INVALID_ORIENTATION = 6


class HandTrackingFrequencyHintMETA(EnumBase):
    DEFAULT = 1
    HIGH = 2


class LightEstimateStateANDROID(EnumBase):
    VALID = 0
    INVALID = 1


class SphericalHarmonicsKindANDROID(EnumBase):
    TOTAL = 0
    AMBIENT = 1
...
class QrCodeTrackingModeANDROID(EnumBase):
    DYNAMIC = 0
    STATIC = 1


class TrackableImageTrackingModeANDROID(EnumBase):
    DYNAMIC = 1
    STATIC = 2


class TrackableImageFormatANDROID(EnumBase):
    R8G8B8A8 = 1


class SceneMeshSemanticLabelSetANDROID(EnumBase):
    NONE = 0
    DEFAULT = 1


class SceneMeshTrackingStateANDROID(EnumBase):
    INITIALIZING = 0
    TRACKING = 1
    WAITING = 2
    ERROR = 3
...
class SceneMeshSemanticLabelANDROID(EnumBase):
    OTHER = 0
    FLOOR = 1
    CEILING = 2
    WALL = 3
...
class SpatialCapabilityEXT(EnumBase):
    ...
    ANCHOR = 1000762000
    IMAGE_TRACKING = 1000782000
    OBJECT_TRACKING_AND = 1000785000
    DEPTH_RAYCAST_AND = 1000786000
...
class SpatialCapabilityFeatureEXT(EnumBase):
    ...
    SPHERE_BOUNDS_FILTER_AND = 1000761000
    BOX_BOUNDS_FILTER_AND = 1000761001
    FRUSTUM_BOUNDS_FILTER_AND = 1000761002
    IMAGE_TRACKING_AUTOMATIC_SIZE_IMAGES = 1000782000
    IMAGE_TRACKING_STATIC_IMAGES = 1000782001
    IMAGE_TRACKING_FIXED_SIZE_IMAGES = 1000782002
...
class SpatialComponentTypeEXT(EnumBase):
    ...
    IMAGE_2D = 1000782000
    OBJECT_SEMANTIC_LABEL_AND = 1000785000
    RAYCAST_RESULT_AND = 1000786000
    SUBSUMED_BY_AND = 1000791000
...
class DynamicObjectTypeBD(EnumBase):
    UNKNOWN = 0
    KEYBOARD = 1000747000
    MOUSE = 1000748000


class CameraPropertyTypeBD(EnumBase):
    FACING = 1
    POSITION = 2
    CAMERA_TYPE = 3


class CameraFacingBD(EnumBase):
    WORLD = 1


class CameraPositionBD(EnumBase):
    UNSPECIFIED = 1
    LEFT = 2
    RIGHT = 3


class CameraTypeBD(EnumBase):
    PASSTHROUGH_COLOR = 1


class CameraCapabilityTypeBD(EnumBase):
    IMAGE_RESOLUTION_AND_FRAME_RATE = 1
    IMAGE_FORMAT = 2
    DATA_TRANSFER_TYPE = 3
    CAMERA_MODEL = 4


class CameraDataTransferTypeBD(EnumBase):
    RAW_BUFFER = 1


class CameraImageFormatBD(EnumBase):
    RGBA_8888 = 1


class CameraModelBD(EnumBase):
    PINHOLE = 1
...
class HapticParametricStreamFrameTypeEXT(EnumBase):
    NONE = 0
    FIRST_FRAME = 1
...
class ColorSpaceSONY(EnumBase):
    SRGB_NONLINEAR = 0
    DISPLAY_P3_LINEAR = 1
    DISPLAY_P3_NONLINEAR = 2
    DCI_P3_LINEAR = 3
    DCI_P3_NONLINEAR = 4
    EXTENDED_SRGB_LINEAR = 5
    BT709_LINEAR = 6
    BT709_NONLINEAR = 7
    BT2020_LINEAR = 8
    BT2020_PQ = 9
...
class SpatialReferenceImageFormatEXT(EnumBase):
    RGBA_8888 = 1
    RGB_888 = 2
    YUV_420_888 = 3


class SpatialObjectSemanticLabelANDROID(EnumBase):
    UNCATEGORIZED = 0
    KEYBOARD = 1
    MOUSE = 2
    LAPTOP_BASE = 3
...
class GoogleCloudAuthErrorANDROID(EnumBase):
    NONE = 0
    QUOTA_EXCEEDED = -1
    UNREACHABLE = -2
    UNKNOWN = -3
...
class GeospatialTrackerStateANDROID(EnumBase):
    STOPPED = 0
    RUNNING = 1
    INITIALIZATION_FAILED = 2


class VPSAvailabilityANDROID(EnumBase):
    UNAVAILABLE = 1
    AVAILABLE = 2


class SurfaceAnchorTypeANDROID(EnumBase):
    TERRAIN = 1
    ROOFTOP = 2


class SpatialContainerGraphicsPresentationEXT(EnumBase):
    SELF_RENDERING = 1000813000


class SpatialContainerBoundsModeEXT(EnumBase):
    BOUNDED = 1
    IMMERSIVE = 2


class SpatialContainerVolumeClippingEXT(EnumBase):
    NONE = 0
    STRICT = 1
...
class SpaceAccelerationFlagsBD(FlagBase):
    NONE = 0x00000000
    LINEAR_VALID_BIT = 0x00000001
    ANGULAR_VALID_BIT = 0x00000002
    ALL = LINEAR_VALID_BIT | ANGULAR_VALID_BIT
...
class LightEstimationCreateFlagsBD(FlagBase):
    NONE = 0x00000000
    SPHERICAL_HARMONICS_BIT = 0x00000001
    ENVIRONMENT_TEXTURE_BIT = 0x00000002
    ALL = SPHERICAL_HARMONICS_BIT | ENVIRONMENT_TEXTURE_BIT


class SoundObstacleFlagsBD(FlagBase):
    NONE = 0x00000000
    ENABLED_BIT = 0x00000001
    POSE_BIT = 0x00000002
    MESH_BIT = 0x00000004
    MATERIALS_BIT = 0x00000008
    ALL = ENABLED_BIT | POSE_BIT | MESH_BIT | MATERIALS_BIT


class SoundObjectFlagsBD(FlagBase):
    NONE = 0x00000000
    ENABLED_BIT = 0x00000001
    POSE_BIT = 0x00000002
    DIRECTIVITY_BIT = 0x00000004
    SHAPE_BIT = 0x00000008
    MAIN_VOLUME_BIT = 0x00000010
    REFLECTION_GAIN_BIT = 0x00000020
    ENABLE_DOPPLER_BIT = 0x00000040
    DIRECT_SOUND_ATTENUATION_BIT = 0x00000080
    INDIRECT_SOUND_ATTENUATION_BIT = 0x00000100
    ALL = ENABLED_BIT | POSE_BIT | DIRECTIVITY_BIT | SHAPE_BIT | MAIN_VOLUME_BIT | REFLECTION_GAIN_BIT | ENABLE_DOPPLER_BIT | DIRECT_SOUND_ATTENUATION_BIT | INDIRECT_SOUND_ATTENUATION_BIT


class SoundFieldFlagsBD(FlagBase):
    NONE = 0x00000000
    ENABLED_BIT = 0x00000001
    ORIENTATION_BIT = 0x00000002
    MAIN_VOLUME_BIT = 0x00000004
    LFE_GAIN_BIT = 0x00000008
    ALL = ENABLED_BIT | ORIENTATION_BIT | MAIN_VOLUME_BIT | LFE_GAIN_BIT
...
class PerformanceMetricsCounterFlagsANDROID(FlagBase):
    NONE = 0x00000000
    ANY_VALUE_VALID_BIT = 0x00000001
    UINT_VALUE_VALID_BIT = 0x00000002
    FLOAT_VALUE_VALID_BIT = 0x00000004
...
class GeospatialPoseFlagsANDROID(FlagBase):
    NONE = 0x00000000
    ORIENTATION_VALID_BIT = 0x00000001
    POSITION_VALID_BIT = 0x00000002
    ALL = ORIENTATION_VALID_BIT | POSITION_VALID_BIT


class BatteryStateDisplayStateFlagsEXT(FlagBase):
    NONE = 0x00000000
    VALID_BIT = 0x00000001
    CHARGING_BIT = 0x00000002
    PLUGGED_IN_BIT = 0x00000004
    NO_BATTERY_BIT = 0x00000008
    ALL = VALID_BIT | CHARGING_BIT | PLUGGED_IN_BIT | NO_BATTERY_BIT


__all__ = [
    "ActionType",
    "AnchorPersistStateANDROID",
    "AudioBufferChannelLayoutBD",
    "AudioSampleRateBD",
    "BatteryStateDisplayStateFlagsEXT",
    "BlendFactorFB",
    "BodyJointBD",
    ...
    "BodyTrackingFidelityMETA",
    "BodyTrackingMessageBD",
    "BodyTrackingPostureBD",
    "BodyTrackingStatusBD",
    "BoundaryVisibilityMETA",
    "CameraCapabilityTypeBD",
    "CameraDataTransferTypeBD",
    "CameraFacingBD",
    "CameraImageFormatBD",
    "CameraModelBD",
    "CameraPositionBD",
    "CameraPropertyTypeBD",
    "CameraTypeBD",
    "ColorSpaceFB",
    "ColorSpaceSONY",
    "CompareOpFB",
    ...
    "EnvironmentRaycastHitStatusMETA",
    "EnvironmentTexturePixelFormatBD",
    "EnvironmentTextureResolutionBD",
    "EnvironmentTextureTransferTypeBD",
    ...
    "FullBodyJointMETA",
    "FutureStateEXT",
    "GeospatialPoseFlagsANDROID",
    "GeospatialTrackerStateANDROID",
    "GlobalDimmerFrameEndInfoFlagsML",
    "GoogleCloudAuthErrorANDROID",
    "HandEXT",
    ...
    "HandTrackingFrequencyHintMETA",
    "HapticParametricStreamFrameTypeEXT",
    "HeadsetFitStatusML",
    "InputSourceLocalizedNameFlags",
    "InstanceCreateFlags",
    "KeyboardTrackingFlagsFB",
    "KeyboardTrackingQueryFlagsFB",
    "LightEstimateStateANDROID",
    "LightEstimationCreateFlagsBD",
    "LipExpressionBD",
    "LipExpressionHTC",
    ...
    "PerformanceMetricsCounterFlagsANDROID",
    "PerformanceMetricsCounterFlagsMETA",
    "PerformanceMetricsCounterUnitANDROID",
    ...
    "SceneMarkerTypeMSFT",
    "SceneMeshSemanticLabelANDROID",
    "SceneMeshSemanticLabelSetANDROID",
    ...
    "SessionCreateFlags",
    "SessionState",
    "SoundFieldChannelMaskAmbixBD",
    "SoundFieldChannelMaskFumaBD",
    "SoundFieldChannelMaskSurroundBD",
    "SoundFieldFlagsBD",
    "SoundObjectDistanceAttenuationTypeBD",
    "SoundObjectFlagsBD",
    "SoundObstacleFlagsBD",
    "SoundObstacleMaterialTypeBD",
    "SpaceAccelerationFlagsBD",
    ...
    "SpatialContainerBoundsModeEXT",
    "SpatialContainerGraphicsPresentationEXT",
    "SpatialContainerVolumeClippingEXT",
    ...
    "SpatialMeshLodBD",
    "SpatialObjectSemanticLabelANDROID",
    ...
    "SpatialReferenceImageFormatEXT",
    "SphericalHarmonicsKindANDROID",
    "SphericalHarmonicsKindBD",
    "StructureType",
    "SurfaceAnchorTypeANDROID",
    "SwapchainCreateFlags",
    "SwapchainCreateFoveationFlagsFB",
    "SwapchainStateFoveationFlagsFB",
    "SwapchainUsageFlags",
    "TrackableImageFormatANDROID",
    "TrackableImageTrackingModeANDROID",
