...
with open("xr/version.py", "w") as v:
    v.write("# Warning: this file is automatically generated.")
    v.write(" Do not edit.\n\n")
    v.write(inspect.cleandoc(
        f"""
        ...
        """))
    # add extra newline because inspect.cleandoc() is too efficient
    v.write("\n")
